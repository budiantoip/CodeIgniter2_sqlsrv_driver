...
class CI_DB_sqlsrv_driver extends CI_DB {
	...
	function _execute($sql)
	{
		...
		// Bug fixed by Budianto IP on 2015-12-18
		// Got a solution from http://forum.codeigniter.com/thread-46691.html
		$sql = $this->_prep_query($sql);
	...
	*/
	function insert_id()
	{
		...
		// Bug fixed by Budianto IP on 2015-12-28
		return $this->query('select @@IDENTITY as id')->row('id');
	}
